...
class ProfilePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    final counter = ref.watch(userDataProvider);
    // return Text('${counter}');
    return Scaffold(
      body: counter.when(
        data: (counter) {
              ...
              child: Column(
                ...
                children: [
                            ...
                            children: [
                              ...
                              Positioned(
                                top: 5 /
                                    ...
                                    MediaQuery.of(context).size.height,
                                right:
                                    5 / 360 * MediaQuery.of(context).size.width,
                                child: IconButton(
                                  icon: Icon(Icons.edit),
                                  onPressed: () {},
                                ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(15),
                      color: counter.isHost! ? kPurple : Colors.white,
                      border: Border.all(color: kPurple, width: 1),
                    ),
                    child: Padding(
                      padding: EdgeInsets.symmetric(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 22,
                              fontWeight: FontWeight.w700,
                              color: counter.isHost! ? Colors.white : kGrey,
                            ),
                          ),
                          Switch(
                            inactiveThumbColor: Colors.white,
